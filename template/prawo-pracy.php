...
<div id="prawo-pracy">
    ...
    <section class="just-title" style="margin-bottom: -60px; margin-top: -30px;">
        <div class="container">
            <div class="row content row-title">
                <div class="col-lg-12">
                    <h2><strong>Pomoc prawna dla pracodawców i pracowników w sprawach spornych</strong></h2>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="uslugi-item__content">
                            <p class="big">Nasze usługi dzielą się na 2 etapy:
                            </p>

                            <ul class="number-list">
                                <li>W pierwszym z nich staramy się dojść do porozumienia pomiędzy pracownikiem a
                                    pracodawcą na drodze negocjacji, czyli w postępowaniu przedsądowym. To zalecane
                                    działanie wstępne, które pozwala na ogromną oszczędność czasu i pieniędzy dla obu
                                    stron.</li>
                                <li>Jeżeli jednak negocjacje nie przynoszą oczekiwanego rezultatu, reprezentujemy
                                    klienta w postępowaniu sądowym oraz egzekucyjnym w oparciu o opracowaną strategię
                                    działania, dostosowaną do jego indywidualnej sytuacji.</li>
                            </ul>

                            Nasze wsparcie ma charakter kompleksowy – na podstawie udzielonego pełnomocnictwa
                            reprezentujemy w klienta w całym procesie.

                        </div>

                    </div>
                    <div class="col-lg-5"></div>
                    <img src="https://rpms.pl/wp-content/uploads/2020/01/AdobeStock_174675830.jpeg" alt=""
                ...
                <div class="col-lg-12">
                    <div class="content">
                        ...
                        <p>Zapewniamy kompleksową obsługę dokumentacji pracowniczej, w tym umów o pracę, umów
                            ...
                            pracowniczych, niezbędnych do prawidłowego funkcjonowania przedsiębiorstwa, w tym: kodeksów
                            etycznych, polityki antymobbinowej i antydyskryminacyjnej, regulaminów pracy, regulaminów
                            wynagradzania i funduszu świadczeń socjalnych, a także zbiorowych układów pracy.</p>
                    </div>
                </div>
            </div>
        </div>
