<?php
/**
* Template Name: Prawo spółek przekształcenia, fuzje i przejęcia
 */
            ...
            <div class="row content">
                ...
                <div class="col-lg-12 big-strong">
                    ...
                    <p>W chwili obecnej przeprowadzamy proces reorganizacji grupy DIGITAL
                        ...
                        HOLDING na każdym etapie niniejszego procesu, zaczynając od wnikliwej analizy kapitałowej,
                        organizacyjnej i personalnej po wypracowanie we współpracy z doradcami podatkowymi najbardziej
                        optymalnej strategii podatkowej niezbędnej przy przeprowadzaniu tego typu procesów. Istotą
                    ...
                    <p>Z powodzeniem przeprowadziliśmy czynności związane z
                        ...
                        towary z całego świata do Polski. Rozwój spółki oraz jej rozbudowana struktura spowodowała, że
                        koniecznym było jej przekształcenie celem dywersyfikacji ryzyka gospodarczego. Dotychczasowa
                        forma prowadzenia spółki okazała się niedostosowana do jej potrzeb, natomiast niewątpliwą zaletą
                    ...
                    <p><strong>Na etapie drugim</strong> konieczne było sporządzenie
                        ...
                        zakresie niniejszego przekształcenia nie było obowiązku sporządzenia wyceny składników
                        majątkowych spółki i poddaniu jej ocenie przez biegłego rewidenta. Istotnym, jednak na tym
                    ...
                    <p><strong>Na etapie trzecim</strong> przygotowaliśmy projekty
                        ...
                        założenia osób biorących udział w przekształceniu – przyszłych wspólników spółki z ograniczoną
                    ...
                    <p>Na każdym z powyższych etapów nasi prawnicy ściśle współpracowali z
                        ...
                        które w wielu przedsiębiorstwach nie jest w ogóle brane pod uwagę bądź stanowi kwestię
                        marginalną. Trzeba mieć jednak na uwadze, że w szczególności przy zmianach formy prowadzenia
                    ...
                    <p><strong>W fazie menadżerskiej</strong> kluczowym było właściwe
                        ...
                        technicznych. Kluczowa była analiza sytuacji prawno-majątkowej spółek, ich sytuacji
                        ekonomiczno-finansowej, aspektów pracowniczych oraz kwestii podatkowych czyli wszystkiego, co
                        składa się na tzw. due diligence. W tej fazie najważniejsza była współpraca naszych prawników z
                        doradcami podatkowymi w celu wypracowania optymalnych rozwiązań podatkowych dla łączących się
                        spółek. Przeanalizowane zostały wszystkie kwestie związane z sukcesją podatkową, podatkiem
