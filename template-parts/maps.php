    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 desc">
                <?php if ( get_field('opis_windykacja') ) : ?>
                <?php echo get_field('opis_windykacja'); ?>
                <?php endif; ?>
            ...
            <div class="col-lg-6">
                ...
                <div id="demo-agents">
                    <ul style="list-style-type: none;" class="p-0">
                        ...
                        <?php if ( have_rows( 'opis_windykacja_powtarzalne' ) ) : ?>
                        <?php while ( have_rows( 'opis_windykacja_powtarzalne' ) ) :
		the_row(); ?>
